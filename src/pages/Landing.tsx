      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] border-b border-white/5 bg-slate-950/50 backdrop-blur-xl">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black text-white tracking-tighter italic">VISIONX</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#tech" className="text-sm font-bold text-slate-400 hover:text-white transition-colors uppercase tracking-widest">Technology</a>
            {user ? (
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              VISION <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">BEYOND</span> LIMITS.
            </motion.h1>
            ...
            >
              Experience the world's first AI-powered optical platform. 
            ...
            >
              {user ? (
                <Link 
                  to="/dashboard"
                  className="w-full sm:w-auto px-10 py-5 gradient-bg rounded-2xl font-black text-white shadow-2xl shadow-cyan-500/20 hover:scale-105 transition-all flex items-center justify-center gap-3 group"
                >
                ...
                <>
                  ...
                  <Link 
                    to="/ai-test"
                    className="w-full sm:w-auto px-10 py-5 bg-white/5 border border-white/10 rounded-2xl font-black text-white hover:bg-white/10 transition-all flex items-center justify-center gap-3"
                  >
                    Free AI Eye Test
                  </Link>
                </>
          ...
          <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter mb-6 leading-none">
                REVOLUTIONIZING <br /> THE OPTICAL EXPERIENCE.
              </h2>
          ...
          <div className="relative rounded-[40px] overflow-hidden bg-gradient-to-br from-cyan-600 to-blue-700 p-12 md:p-24 text-center">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-cyan-50 text-xl mb-12 opacity-80">
                Join thousands of users who have already upgraded their vision experience with VisionX.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-slate-500 text-sm font-medium">
              © 2026 VisionX AI Optical. All rights reserved.
            </p>
